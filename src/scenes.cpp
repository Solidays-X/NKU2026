...
void SceneEngine::dormDesk() {
    ...
    MW->showChoices(QStringLiteral("<b>桌前</b><br/>桌上放着你的一些物品。"), choices);
}
...
void SceneEngine::triggerHiddenEnding(int branch) {
    if (branch == 1) {
        ...
        QString body = QStringLiteral(
            ...
            "宿舍天花板的纹路，和每一次醒来时一模一样。\n"
            "但有什么不同了——手机屏幕亮着，时间是周一。\n"
            "你慢慢坐起来，打开了电脑。…… 提交成功。截止时间：今天 23:59。\n"
            "出门时，海棠树还是那棵海棠树。"
